    ...
    <nav class="navbar navbar-inverse" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand navbar-collapse collapse" href="officerindex.php"><img src="images/logo.png" /></a>

                <a class="navbar-brand navbar-toggle" data-toggle="collapse" href="officerindex.php">WAEC Supervisors' E-Registration Portal</a>
            </div>
    ...
    <!-- header ends here -->
        ...
        <div class="titler">
			...
			<?php
				...
				echo "Hi Officer ". $_SESSION["fullname"];
				}
            ?>    
            </div>
        </div>
