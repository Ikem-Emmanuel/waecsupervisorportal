   		...
   		<div class="container">
			...
			<div class="search_line row">
				...
				<div class="col-md-8 text-right top_10">
					<a href="active.php">View Active Supervisors</a> <a href="viewsupervisors.php">View full list of Supervisors</a>
				</div>
			...
			<div class="row">
				...
				$result= $misc->viewInactivePaginator($start_from,$num_rec_per_page,$officeId);
				$result2= $misc->viewInactiveSupervisor($officeId);

				if(mysqli_num_rows($result2)== 0){
					$errorMsg="NO INACTIVE SUPERVISORS!!!";
					echo ($notifyObject->errorMessage($errorMsg));
				}
				else{ ?>

				<h2 class="titled">List of all your INACTIVE registered supervisors</h2>
					...
					<?php
						...
						while ($row = $result->fetch_assoc()) {
							...
							<td class="text-center">
								...
								<?php } else{ ?>
									<a href="<?php echo "activate.php?id=".$id?>"> <button name="delete" class="btn btn-danger btn-sm">Activate Supervisor</button></a>
								<?php } ?>
							</td>
				...
				<div class="paginator">
					<?php
						...
						if($page == 1){
							echo "<a href='inactive.php?page=1' style='text-decoration: underline'>".'First'."</a> | "; // Goto 1st page  
						}else{
							echo "<a href='inactive.php?page=1'>".'First'."</a> | "; // Goto 1st page 
						}
						

						for($i=2; $i<$total_pages; $i++){ 
							if($i == $page){
								echo "<a href='inactive.php?page=".$i."' style='text-decoration: underline'>".$i."</a> ";
							}else{
						...
						if($page == $total_pages){
							echo " | <a href='inactive.php?page=$total_pages' style='text-decoration: underline'>".'Last'."</a>"; // Goto last page
						}else{
							echo " | <a href='inactive.php?page=$total_pages'>".'Last'."</a>"; // Goto last page
						}
